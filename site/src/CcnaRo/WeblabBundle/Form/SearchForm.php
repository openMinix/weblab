<?php
namespace CcnaRo\WeblabBundle\Form;

use Symfony\Component\Form\AbstractType;
use Symfony\Component\Form\FormBuilderInterface;
use Mopa\Bundle\BootstrapBundle\Navbar\NavbarFormInterface;

class SearchForm extends AbstractType implements NavbarFormInterface
{
    ...
    {
        return "home"; # return here the name of the route the form should point to
    }
}